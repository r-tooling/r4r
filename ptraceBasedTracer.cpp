...
int main(int argc, char* argv[])
{
	...
	program.add_description("The tracer is used for analysing the dependencies of other computer programs.");
	...
	if (!program.is_used("--analyse")) {
		...
		*/
		...
		pid_t childPid = spawnProcessWithSimpleArgs(inPipe.get(), outPipe.get(), errPipe.get(), programName, ArgvWrapper{ args }, callback);//arg 1 == my filename, arg 2 == his filename
