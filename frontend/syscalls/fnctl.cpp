...
namespace frontend::SyscallHandlers {
	...
	void Fcntl::exit(processState& process, middleend::MiddleEndState& state, long syscallRetval)
	{
	...
	void Fcntl::entryLog(const processState& process, const middleend::MiddleEndState& state, long syscallNr)
	{
