...
namespace frontend::SyscallHandlers {
		...
		WarnHandlerClass(SYS_getrandom) //TODO: this is called in the process init, do not spam from there

		WarnHandlerClass(SYS_getpid) //TODO:  coudl be resolved by PID namespaces
		WarnHandlerClass(SYS_getppid)

		WarnHandlerClass(SYS_sysinfo) //TODO: also could be used for data about the current system
