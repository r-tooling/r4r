...
The first table lists the instruction used to transition to
           ...
           ───────────────────────────────────────────────────────────────────
                 ...
                 The second table shows the registers used to pass the system
call arguments. Arch/ABI      arg1  arg2  arg3  arg4  arg5  arg6  arg7  Notes
...
inline long getSyscallParam(
    pid_t processPid) { // it is impossible to have validation if the given
                        // syscall actually has these arguments at this point.
